        ...
        child: Observer(
          builder: (_) => Card(
            child: BackgroundContainer(
              backgroundImage: 'assets/images/${dataStore.selectedSabbat?.name}.png',
              child: ContentContainer(
                child: dataStore.hasInternet ? const SabbatSingleContent() : const CheckConnectionNotification(),
              ),
            ),
          ),
        ),
